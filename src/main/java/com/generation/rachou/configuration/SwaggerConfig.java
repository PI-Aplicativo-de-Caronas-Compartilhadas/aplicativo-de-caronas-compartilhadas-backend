package com.generation.rachou.configuration;
...
public class SwaggerConfig {
	...
	@Bean
    OpenAPI springRachouOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Projeto App Caronas Compartilhadas - Rachou")
                .description("Projeto App Caronas Compartilhadas - Generation Brasil")
                .version("v0.0.1")
                .license(new License()
